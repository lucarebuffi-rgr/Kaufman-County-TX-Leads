...
DOC_TYPES = {
    ...
    "PROBATE PROCEEDINGS, CERTIFIED COPY"       : ("probate",         "Probate",             "PB"),
    "AFFIDAVIT OF HEIRSHIP"                     : ("probate",         "Affidavit of Heirship","AFH"),
    "LIEN AFFIDAVIT/CLAIM/NOTICE"               : ("lien",            "Lien",                "LC"),
    "HOSPITAL LIEN"                             : ("lien",            "Hospital Lien",       "HL"),
    "CHILD SUPPORT LIEN"                       : ("lien",            "Child Support Lien",  "CSL"),
    "ASSSESSMENT LIEN BY HOMEOWNERS ASSOCIATION": ("lien",            "HOA Lien",            "ALN"),
    "DIVORCE PROCEEDINGS, CERTIFIED COPY"       : ("other",           "Divorce Decree",      "DV"),
...
SCITY_S, SCITY_E = 4741, 4771
SZIP_S,  SZIP_E  = 4846, 4851
